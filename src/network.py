...
class Network(object):
    ...
    def update_mini_batch(self, mini_batch, eta):
        ...
        nabla_b, nabla_w = self.backprop(X, Y, mini_batch)
    ...
    def backprop(self, X, Y, mini_batch):
        ...
        nabla_B = [np.tile(np.zeros(b.shape), (1, len(mini_batch)))
        ...
        for b, w in zip(self.biases, self.weights):
            B = np.tile(b, (1, len(mini_batch)))  # repeat column b for each training example
